...
# class Documents(ConversationalRetrievalChain):
#     def get_docs_manual(self, question, inputs):
#         return self._get_docs(question,inputs)
#
#
# documents = Documents(
#     retriever=retriever,
# )
#
# docs = documents.get_docs_manual(question="Name three study programs at the University", inputs={})
...
# docs = get_docs ('Name three study programs at the University')
# # {'question': 'Name three study programs at the University', 'chat_history': ''}
# a = chain.invoke({"input_documents": docs, "question": "Name three study programs at the University"})
#
# stand_alone_template = (
#     "Combine the chat history and follow up question into "
#     "a standalone question. Chat History: {chat_history}"
#     "Follow up question: {question}"
# )
# stand_alone_template_prompt = PromptTemplate.from_template(stand_alone_template)
#
#
# question_generator_chain = LLMChain(llm=chat_model, prompt=stand_alone_template_prompt)
#
...
#
#
# a= chain.invoke({"question": "Name three study programs at the University"})
#
# b= chain.invoke({"question": "Tell me more about the second program"})
#
# print()
...
# result = chat_model(messages)
    ...
    #     print(
    #         f"Retrieved {len(docs)} documents for question: {message}"
    #     )
