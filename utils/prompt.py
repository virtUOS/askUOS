...
template_messages = [
    SystemMessagePromptTemplate(prompt=PromptTemplate(input_variables=['input', 'chat_history', 'agent_scratchpad'],
                                                      template="""
                                                                       As a university advisor for the University of Osnabrück in Germany, you provide assistance and support to individuals interested in studying at the university, as well as to current students. 
