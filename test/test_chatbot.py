...
class AgentExecutorTest(unittest.TestCase):
    ...
    def test_output(self):
        ...
        self.assertEqual(len(response['chat_history']), 2, "Chat history is not being kept.")
        ...
        score = evaluator.evaluate_string_pairs(prediction=response['output'], prediction_b=expected_output)
