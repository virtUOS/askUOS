...
# TODO write test to test the markdown generated by crawl4ai, especially the urls, it seems that crawl4ai is adding this to urls <>
# TODO for example, extract all links from the markdown and compare them with the href attribute of the links (provided by the result object of crawl4ai)
