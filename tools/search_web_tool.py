...
def extract_and_visit_links(rendered_html):
        contents = []
        visited_links = set()
...
# class SearchUniWeb(BaseTool,
              
#                   ):
#     """My custom tool."""

#     name: str = "custom_university_web_search"
#     description: str = prompt_language()['description_university_web_search'],
#     args_schema: Type[SearchUniWebToolSchema] = SearchUniWebToolSchema
